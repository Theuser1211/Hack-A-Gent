...
const APP: AppData = {"name":"Quarry","tagline":"Quarry — a reverse search engine that turns a vague memory into the exact video, article, or song you cannot name.","problem":"Ship apps and start making money.","features":["Siftline core loop: one screen from first click to result","Live ai data with graceful empty and loading states","Replit integration driving the main mechanic","One polished, scripted live path with seed data","Graceful empty/loading/error states for every screen","Deployed demo URL reachable from the judging room"],"criteria":[],"sponsors":[],"screens":["Input — provide data or prompt to the AI model","Processing — show model working, streaming, or reasoning","Output — display results, confidence scores, or generated content"],"theme":"dev","primaryFeature":"Siftline core loop: one screen from first click to result","inputLabel":"Paste code or describe the bug","analyzeVerb":"Diagnose","sample":"TypeError: Cannot read properties of undefined (reading \"map\") in Dashboard.tsx at line 42, after the recent API response shape change.","workflowSteps":["Paste the code","Diagnose the issue","Apply the fix"]};
