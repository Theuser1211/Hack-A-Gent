...
const APP = {"name":"Haven","tagline":"Haven — a planning agent that stress-tests your roadmap against the ways projects die and patches the top risk first.","problem":"Patient Flow is a website for healthcare providers to efficiently manage patient care. Providers could view, update, and delete records, and potential additions include medication reminders.","features":["Responsive UI with polished interactions","Deployed live demo accessible via URL"],"criteria":[],"sponsors":[],"screens":["Input — provide data or prompt to the AI model","Processing — show model working, streaming, or reasoning","Output — display results, confidence scores, or generated content"],"theme":"health","primaryFeature":"Responsive UI with polished interactions","inputLabel":"Describe a patient scenario","analyzeVerb":"Assess risk","sample":"A 62-year-old patient with chest pain, shortness of breath, and a history of hypertension. Symptoms started 2 hours ago."};
